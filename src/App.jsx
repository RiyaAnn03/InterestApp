...
const handleReset =()=>{
  ...
  <div style={{width:'600px'}} className='bg-light rounded p-5'>   
    ...
    <form className='mt-5'>
      {/* principle amount */}
      <div className="mb-3">
      <TextField value={principle|| ""} name='principle' onChange={(e)=>validateInputs(e.target)} className='w-100' id="outlined-principle" label=" ₹ Princple Amount" variant="outlined" />
      </div>
      {/* invalid principle */}
